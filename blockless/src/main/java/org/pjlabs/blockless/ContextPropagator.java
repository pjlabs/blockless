 ...
 * <p>
 * Implementations live in separate modules (e.g. {@code blockless-context-grpc}) so callers only
...
public interface ContextPropagator {
    ...
    /**
     * Applies {@code captured} on the current thread. Returns an opaque token for {@link #restore(Object)}.
     */
